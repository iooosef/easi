...
export default function Inventory() {
  ...
  // Edit Usage sub-modal (appears on top of ManageMenu)
  ...
  async function handleEditUsageSubmit(e) {
    ...
    try {
      ...
      // Refresh usage history for the currently open ManageMenu part
      if (selectedPart) {
        apiFetch(`/api/part-usages?partId=${selectedPart.partId}&size=50&sort=usedOn,desc`)
  ...
  return (
    <Layout activePage="inventory">
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <button type="submit" form="usage-form" className="btn btn-warning" disabled={usageSubmitting}>
              {usageSubmitting
                ? <span className="loading loading-spinner loading-sm"></span>
                  ...
                  {totalSupplierPages > 1 && (
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <div className="flex gap-1">
                        <button className="btn btn-xs btn-secondary" disabled={manageSuppliersPage === 0} onClick={() => setManageSuppliersPage(p => p - 1)}>
                          <span className="icon-[tabler--chevron-left] size-3"></span>
                        </button>
                        <button className="btn btn-xs btn-secondary" disabled={manageSuppliersPage >= totalSupplierPages - 1} onClick={() => setManageSuppliersPage(p => p + 1)}>
      ...
      {/* Edit Usage Sub-modal — sits above ManageMenu via higher z-index */}
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        placeholder="Leave blank if not from an SR"
                        value={editUsageForm.srNumber}
                        onChange={e => setEditUsageForm(prev => ({ ...prev, srNumber: e.target.value }))}
                      />
