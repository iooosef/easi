...
const MENU_ITEMS = [
  { key: 'update',    label: 'Update Details',          icon: 'icon-[tabler--pencil]' },
  { key: 'schedule',  label: 'Manage Schedule',         icon: 'icon-[tabler--calendar]' },
  { key: 'documents', label: 'Manage Documents',        icon: 'icon-[tabler--files]' },
  { key: 'ac',        label: 'Manage Air Conditioners', icon: 'icon-[tabler--snowflake]' },
]
...
export default function ManageMenu({ project, isOpen, onClose, onMenuSelect }) {
