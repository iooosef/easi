...
function AddACUnitModal({ projNumInt, onSuccess }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      popModal();
      setTimeout(
        () => notyfSuccess(`AC Unit #${data.acNum} added successfully.`),
        150,
      );
      onSuccess?.();
    } catch (err) {
        ...
        <form id="new-ac-form" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex flex-col gap-1">
              ...
              />
              {formError.brand && (
                <span className="helper-text">{formError.brand}</span>
              )}
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              />
              {formError.model && (
                <span className="helper-text">{formError.model}</span>
              )}
            </div>
            ...
            <div className="sm:col-span-2 flex flex-col gap-1">
              ...
              />
              {formError.serialNum && (
                <span className="helper-text">{formError.serialNum}</span>
              )}
            </div>
...
function UpdateACUnitModal({ unit, projNumInt, onSuccess }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      popModal();
      setTimeout(
        () => notyfSuccess(`AC Unit #${unit.acNum} updated successfully.`),
        150,
      );
      onSuccess?.();
    } catch (err) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-base-content/60 mt-1">
              View and manage AC units for this project
            </p>
          </div>
        </div>
                ...
                <tbody>
                  {filtered.map((u) => (
                    <tr key={u.acNum}>
                      ...
                      <td>
                        <span
                          className={`badge badge-soft ${statusBadgeClass(u.status)} text-xs`}
                        >
